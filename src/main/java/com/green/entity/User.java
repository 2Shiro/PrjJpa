...
// @NoArgsConstructor(access = AccessLevel.PROTECTED)
 // Lombok 버전오류 1.18.30.jar 오류발생
 // Lombok annotation handler class lombok.eclipse.handlers.HandleConstructor$HandleNoArgsConstructor failed - See error log.	User.java	/PrjJpa05/src/main/java/com/green/entity	line 1	Annotation Problem (Java 6 processor)
@NoArgsConstructor
@Getter
